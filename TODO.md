...
- [x] Initialize Fumadocs project with TanStack Start and Bun
- [x] Configure "Black" theme and layout
- [x] Implement Phase 2: Modular Sync Pipeline
- [x] Integrate `warforthecrown` submodule content into Fumadocs (writeups)
